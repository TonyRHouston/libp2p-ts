 ...
 * @enum {string}
 */
export declare enum TextMatchingStrategy {
    Exact = "exact",
    Iexact = "iexact",
    Partial = "partial",
    Ipartial = "ipartial"
}
export declare function TextMatchingStrategyFromJSON(json: any): TextMatchingStrategy;
export declare function TextMatchingStrategyFromJSONTyped(json: any, ignoreDiscriminator: boolean): TextMatchingStrategy;
export declare function TextMatchingStrategyToJSON(value?: TextMatchingStrategy | null): any;
