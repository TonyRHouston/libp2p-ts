...
export declare function PinFromJSON(json: any): Pin;
export declare function PinFromJSONTyped(json: any, ignoreDiscriminator: boolean): Pin;
export declare function PinToJSON(value?: Pin | null): any;
